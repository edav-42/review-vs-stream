...
The graph on the right shows popularity vs. danceability. We can clearly see the trend of increasing popularity as danceability increases. Also, for a given danceability, the upper bound of the popularity increases with the increase of danceability.
```{r}
